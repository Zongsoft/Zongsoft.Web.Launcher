...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder" runat="server">
	...
	<zs:Widget ID="Inputs" Title="输入框" runat="server">
		<HeaderTemplate>
		...
		<ContentTemplate>
			...
			<zs:LayoutPanel LayoutMode="Flow" LayoutColumns="2" runat="server">
				...
				<zs:LayoutPanelCell runat="server">
					<zs:CheckBox ID="chk1" Label="我是一个复选框" Checked="false" runat="server" />
